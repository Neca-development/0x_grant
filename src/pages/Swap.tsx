      ...
      <div className="flex mt-12">
        ...
        <div className="flex-1">
          ...
          {selectedToken ? (
            ...
            <div className="aspect-square overflow-auto w-3/5 bg-gray-200 rounded-2xl border-dashed border border-gray-500 p-6 grid grid-cols-2 gap-6 relative">
              {showTokensList ? (
                ...
                <div
                  className="text-md text-gray-500 font-semibold h-full w-full flex items-center justify-center absolute t-0 l-0 cursor-pointer"
                  onClick={() => setShowTokensList(true)}
                >
                  Choose your NFT to swap
                </div>
              )}
              {showTokensList && userTokens?.length === 0 && (
                <div className="text-md text-gray-500 font-semibold h-full w-full flex items-center justify-center absolute t-0 l-0">
                  There's no NFT on your balance
                </div>
              )}
            </div>
          )}
